  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 dark:text-white py-10 px-4">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-xl lg:text-3xl font-bold mx-auto px-3 py-2 bg-[#F80136] text-white w-fit mb-8">How to Add a Review</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
       
          <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
            <div className="w-16 h-16 bg-blue-100 text-blue-700 flex items-center justify-center rounded-full mb-4 text-2xl font-bold">
              1
            </div>
